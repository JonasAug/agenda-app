...
export class ContatoDetalhePage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private contatosProviders: ContatosProvider) {
  ...
  confirmaContato(){
    ...
    if(this.cttparam != null) {
      ...
      this.contatosProviders.addContato(c.nome, c.endereco, c.cep, c.lat, c.long, c.email);
    }
